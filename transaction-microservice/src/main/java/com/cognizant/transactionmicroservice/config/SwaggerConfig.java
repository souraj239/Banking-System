package com.cognizant.transactionmicroservice.config;
...
public class SwaggerConfig { 
	...
	public Docket api() { 
		...
		Docket docket= new Docket(DocumentationType.SWAGGER_2)  
				.select()                                  
				.apis(RequestHandlerSelectors.basePackage("com.cognizant.transactionmicroservice"))              
	...
	private ApiInfo apiDetails() {
		ApiInfo apiInfo= new ApiInfoBuilder()
				.title("Transactionmicroservice Documentation")
				.description("It gives the List Of transaction and statement.")
